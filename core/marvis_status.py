...
CAPABILITY_LEDGER = [
    ...
    },
    {
        ...
        "status": "ready",
        "evidence": "Quick/model compliance modes plus persisted reports and baseline comparison",
        "weight": 12,
        "earned": 12,
    },
    {
        ...
        "status": "partial",
        "evidence": "2.5D factory floor with worker templates, batch creation, config, TaskBook composition, filters and compliance baselines",
        "weight": 10,
        "earned": 9,
    },
    {
    ...
    },
    {
        "key": "agent-isolation",
        "status": "partial",
        "evidence": "Per-worker workspace/profile/skills paths plus taskbook input/output path policy",
        "weight": 6,
        "earned": 3,
    },
    {
...
BLUEPRINT_MILESTONES = [
    {
        ...
        "next_step": "Add reusable template export/import packs",
    },
    {
        "phase": "P0",
    ...
    },
    {
        ...
        "title": "Factory API",
        "status": "ready",
        "evidence": "runs, events, artifacts, quality, manifest, preflight, compliance and baseline endpoints",
        "next_step": "Add paginated artifact search",
    },
    {
        "phase": "P0",
    ...
    },
    {
        ...
        "status": "ready",
        "evidence": "worker cards, health summary, config editing, document installation, tag/group management, templates and batch creation are present",
        "next_step": "Add template import/export and bulk validation",
    },
    {
        "phase": "P1",
        ...
        "status": "ready",
        "evidence": "isometric floor shows multiple lines, step machines, selected workers, density controls and multi-run filtering",
        "next_step": "Add browser screenshot regression checks for desktop and mobile",
    },
    {
        "phase": "P1",
        "key": "artifact-audit",
        ...
        "status": "ready",
        "evidence": "run manifests, artifact drawers, cross-run artifact index and artifact diff expose provenance",
        "next_step": "Add richer report comparison UI",
    },
    {
        "phase": "P1",
        ...
        "status": "ready",
        "evidence": "model mode can run against configured worker backends and compare saved Moon Bridge / DeepSeek baselines",
        "next_step": "Add baseline trend history",
    },
    {
        "phase": "P1",
        "key": "agent-isolation",
        ...
        "status": "partial",
        "evidence": "per-worker workspace/profile/skills paths exist and taskbook path policy blocks unsafe input/output contracts",
        "next_step": "Add backend-specific sandbox flags and permission audit logs",
    },
    {
        "phase": "P2",
